...
func (tdc *TikiDocumentCollection) DocumentHandles() (result []TikiDocumentHandle) {
...
func (tdc *TikiDocumentCollection) Find(handle TikiDocumentHandle) (TikiDocument, error) {
	for _, doc := range tdc.Documents {
